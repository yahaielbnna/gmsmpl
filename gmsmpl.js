...
function gm(element) {
    try {
        ...
        if (el == null) {
            ...
            console.warn(
                `Oh! We couldn't find --- [ ${element} ] ---- in the page, please try to check your spelling or check the existence of this element in the page`
            );
        } else {
            const self = {
                element: (_) => {
                ...
                input: (
                    ...
                    if (el.tagName.toLowerCase() == "form") {
                        ...
                        gmsmple_error_code_warn();
                        console.error(
                            `you should add the input into a form not a ${el.tagName}!`
                        );
                    }
                },
                inputContainer: (
                ...
                button: (
                    ...
                    if (el.tagName.toLowerCase() == "form") {
                        ...
                        gmsmple_error_code_warn();
                        console.error(
                            `you should add the button into a form not a ${el.tagName}!`
                        );
                    }
                },
                            ...
                            try {
                                ...
                                inputs.forEach((input) => {
                                    if (isEmpty(input.value)) {
                                        ...
                                        msg = {
                                            code: 302,
                                            massege: `${input.name} field is empty`,
                                            name: input.name,
                                            id: input.id,
                                            input: input,
                                        };
                                ...
                                if (Boolean(el.getAttribute("gm-validate"))) {
                                    ...
                                    emailInputs.forEach((input) => {
                                        if (!emailValidation(input.value)) {
                                            ...
                                            msg = {
                                                code: 302,
                                                massege: `${input.name} field's value doesn't correct ! `,
                                                name: input.name,
                                                id: input.id,
                                                input: input,
                                            };
                ...
                CreateList: (listElementsMap, UlClass = null, ULID = null) => {
                    return self;
                },
                width: (width) => {
                ...
                maxWidth: (width) => {
                    if (typeof width == "number") el.style.maxWidth = width + "px";
                    else el.style.maxWidth = width;
                    return self;
                },
                maxHeight: (height) => {
                    if (typeof height == "number") el.style.maxHeight = height + "px";
                    else el.style.maxHeight = height;
                    return self;
                },
                margin: (margin) => {
                ...
                fontSize: (size) => {
                    if (typeof size == "number") el.style.fontSize = size + "px";
                    else el.style.fontSize = size;
                    return self;
                },
                bg: (color) => {
                ...
                radius: (radius) => {
                    ...
                    else el.style.borderRadius = radius;
                    return self;
                },
                TLradius: (radius) => {
                    if (typeof radius == "number")
                        el.style.borderTopLeftRadius = radius + "px";
                    else el.style.borderTopLeftRadius = radius;
                    return self;
                },
                TRradius: (radius) => {
                    if (typeof radius == "number")
                        el.style.borderTopRightRadius = radius + "px";
                    else el.style.borderTopRightRadius = radius;
                    return self;
                },
                BLradius: (radius) => {
                    if (typeof radius == "number")
                        el.style.borderBottomLeftRadius = radius + "px";
                    else el.style.borderBottomLeftRadius = radius;
                    return self;
                },
                BRradius: (radius) => {
                    if (typeof radius == "number")
                        el.style.borderBottomRightRadius = radius + "px";
                    else el.style.borderBottomRightRadius = radius;
                    return self;
                },
                shadow: (shadow) => {
...
function gmsmple_error_code_warn() {
    return console.warn(
        "%cgmsmpl " + "%csay that you have an " + "%cerror " + "%cin your code !",
